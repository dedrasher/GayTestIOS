...
struct ContentView: View {
    ...
    var body: some View {
      ...
      showAlert = true
        ...
        }.navigationBarTitle(isNavigationBarHidden ? "" : "History", displayMode: isNavigationBarHidden ? .inline : .automatic).onChange(of: selectedTab) { newValue in
            if(selectedTab == 0) {
        ...
        }.navigationBarBackButtonHidden(true).navigationBarHidden(isNavigationBarHidden)
    }
}
